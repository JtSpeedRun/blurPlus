    ...
    export function FadeOut() {
        ...
        `, SpriteKind.Player)
            ...
            for (let index3 = 0; index3 < 15; index3++) {
                for (let index4 = 0; index4 < 190 / numheight2; index4++) {
                    if (190 - y2 < number) {
                        numheight2 = 190 - y2
                    }
                    for (let index5 = 0; index5 < 256 / numwidth2; index5++) {
                        if (256 - x2 < number) {
                            numwidth2 = 256 - x2
                        }
    ...
    export function FadeIn() {
        ...
        `, SpriteKind.Player)
            ...
            for (let index6 = 0; index6 < 15; index6++) {
                for (let index7 = 0; index7 < 190 / numheight3; index7++) {
                    if (190 - y3 < number2) {
                        numheight3 = 190 - y3
                    }
                    for (let index8 = 0; index8 < 256 / numwidth3; index8++) {
                        if (256 - x3 < number2) {
                            numwidth3 = 256 - x3
                        }
