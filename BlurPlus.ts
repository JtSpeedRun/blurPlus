...
let variable1 = scene.createRenderable(zLayerBlur1, (image1: Image, camera: scene.Camera) => {
    ...
    if (blurSize1 != 1) {
        ...
        helpers.imageBlit(tempImg, 0, 0, Math.ceil(256 / blurSize1), Math.ceil(190 / blurSize1), screenClone, 0, 0, 256, 190, true, false)
        helpers.imageBlit(image1, (tempImg.width * blurSize1 - 256) / -2, (tempImg.height * blurSize1 - 190) / -2, tempImg.width * blurSize1, tempImg.height * blurSize1, tempImg, 0, 0, tempImg.width, tempImg.height, true, false)
    }
})
//% color="#83de8a"
//% block="BlurPlus"
